...
const Footer = () => {
  return (
    <footer className="bg-gradient-to-b from-[#458bec] to-[#2469de] py-5 font-sans tracking-wide">
      <div className="container m-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 px-10 py-8">
        <div>
          <img src={images.logoF} alt="logo-favion" />
      ...
      <div className="bg-cyan-600 bg-opacity-40 p-5">
        <p className="text-gray-100 text-base text-center">
          2024 © Farm Of Medicine. All rights reserved.
        </p>
      </div>
    </footer>
  );
