...
const CategoriesPage = () => {
  ...
  const category = categoriesData.getBySlug(params.slug);

  const products = productsData.getByCategorySlug(params.slug);
  ...
  return (
    <div className="mb-10">
      <section className="relative bg-white h-40 md:h-64 bg-[url('https://flowbite.s3.amazonaws.com/docs/jumbotron/hero-pattern.svg')]">
        <div className="h-40 md:h-64 py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 z-10 relative flex justify-center items-center">
          <h1 className="text-3xl stroke-2 stroke-blue-500 font-extrabold uppercase tracking-tight leading-none text-white md:text-5xl lg:text-6xl">
            {category.name}
          </h1>
        </div>
      ...
      <div className="container m-auto px-5 md:px-0">
        <div className="w-full h-14 bg-white my-5 rounded-md shadow flex justify-between items-center px-5">
