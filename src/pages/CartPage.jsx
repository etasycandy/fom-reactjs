    ...
    <section className="bg-white pb-8 antialiased pt-7">
      <div className="mx-auto px-5 container">
        ...
        <div className="mt-6 grid grid-cols-10 gap-4">
                ...
                >
                  <div className="space-y-4 md:flex md:items-center md:justify-between md:gap-6 md:space-y-0">
                    ...
                    <div className="w-full min-w-0 flex-1 space-y-4 md:order-2 md:max-w-md">
                      <Link to="#">
                        <Tooltip
                          content={`PC system All in One APPLE iMac (2023) mqrq3ro/a, Apple M3, 24" Retina 4.5K, 8GB, SSD 256GB, 10-core GPU, Keyboard layout INT`}
          ...
          <div className="col-span-10 lg:col-span-3 mx-auto mt-6 max-w-4xl flex-1 space-y-6 lg:mt-0 lg:w-full">
